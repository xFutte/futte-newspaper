...
2. Add `exports['newsstands']:CreateJailStory(name, time)` wherever you jail a player server side, parsing the name of the prisoner and the time sentenced as parameters.
